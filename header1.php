...
<html class="no-js">
    <head>
        <title>:: collaborative learning Management System</title>
		<meta name="description" content=" Collaborative Learning Management System">
		<meta name="keywords" content="COEIKWO LMS,COEIKWO LMS,COEIKWO,LMS,COEIKWO LMS.COEIKWO">
		<meta name="author" content="EMENIKE CHINEDU E">
		<meta charset="UTF-8">
        <!-- Bootstrap -->
				...
				<!-- index css -->
				<link href="admin/bootstrap/css/index1.css" rel="stylesheet" media="screen"/>
				<!-- data table css -->
