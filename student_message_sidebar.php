<div class="span3" id="sidebar">
		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
			<li class=""><a href="dashboard_student.php"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;My Class</a></li>
             ...
             <li class=""><a href="CourseList.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp; My Enrolled Courses</a></li>
             
              <li class=""><a href="CourseList.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp; Assign Courses</a></li>
              
              
               <li class=""><a href="CourseList.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp; Assignments</a></li>
