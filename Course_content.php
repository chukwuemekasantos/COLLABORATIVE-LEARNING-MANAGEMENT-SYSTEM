                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							#btn{
								...
								height:30px;}
								#btn1{
								background-image:url(admin/images/Resume-button.jpg);
								width:100px;
								height:30px;}
								#btn2{
									background-image:url(admin/images/Completed-button.jpg);
								width:100px;
								height:30px;}
	...
	while ($row = mysql_fetch_array($query)) {
		...
		?>								        
										...
										<td width="30">
                                         ...
                                         <td>2018 &nbsp; &nbsp;</td>                                     <?php  
		if(isset($code)){
											$query_c = mysql_query("select *  from course_completiondb where Course_Code = '$code' AND  Course_Start='Start' ") or die(mysql_error());
											$count_c = mysql_num_rows($query_c);
	
	
										 if($count_c <=0 ){
											 ?>
                                         <td width="30"><input type="button"  onclick="window.location.href='pages.php?id=<?php echo $code;?>'" id="btn"  /></td>
	<?php
	}else{
		
	
	?>
     <td width="30"><input type="button"  onclick="window.location.href='pages.php?id=<?php echo $code;?>'" id="btn1" /></td>
