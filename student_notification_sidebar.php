		...
		<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
            ...
            <li class=""><a href="Course_content.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp; My Enrolled Courses</a></li>
              ...
              <li class=""><a href="Course_content.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp; Assign Courses</a></li>
               ...
               <li class=""><a href="Course_content.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp; Assignments</a></li>
               
               
                <li class=""><a href="Course_content.php"><i class="icon-chevron-right"></i><i class="icon-suitcase"></i>&nbsp; Grade</a></li>
