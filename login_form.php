			...
			<hr>
				...
				<button data-placement="top" title="Sign In as Instructor" id="signin_Instructors" onclick="window.location='signup_instructors.php'" name="login" class="btn btn-info" type="submit">I`m a Instructors</button>
