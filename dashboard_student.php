                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
						<?php
						$school_year_query = mysqli_query("select * from school_year order by school_year DESC")or die(mysqli_error());
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-right">
									<?php $query = mysqli_query("select * from teacher_class_student
